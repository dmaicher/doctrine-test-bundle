...
3. Starting from version 8 you need to make sure you have `use_savepoints` enabled on your doctrine DBAL configuration (dama_doctrine_test_bundle.ymal) for all relevant connections:
