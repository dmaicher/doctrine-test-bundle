...
2. Make sure you also have `phpunit/phpunit` available as a `dev` dependency (**versions 11, 12 and 13 are supported with the built-in extension**) to run your tests. 
